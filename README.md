...
[![Maven Central](https://img.shields.io/maven-central/v/com.manolodominguez/openlrae-maven-plugin)](https://search.maven.org/artifact/com.manolodominguez/openlrae-maven-plugin/1.5/jar)
...
- <b>OpenLRAE Maven Plugin 1.6-SNAPSHOT</b> (development branch) - Apache-2.0.

## Binary releases:

- <b>OpenLRAE Maven Plugin 1.5</b> (current, master branch) - Apache-2.0.
- <b>OpenLRAE Maven Plugin from 0.8 to 1.4</b> - Apache-2.0.
