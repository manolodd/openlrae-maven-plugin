...
[![Maven Central](https://img.shields.io/maven-central/v/com.manolodominguez/openlrae-maven-plugin)](https://search.maven.org/artifact/com.manolodominguez/openlrae-maven-plugin/1.4/jar)
...
- <b>OpenLRAE Maven Plugin 1.5-SNAPSHOT</b> (development branch) - Apache-2.0.

## Binary releases:

- <b>OpenLRAE Maven Plugin 1.4</b> (current, master branch) - Apache-2.0.
- <b>OpenLRAE Maven Plugin from 0.8 to 1.3</b> - Apache-2.0.
...
- openlrae-1.4 - Apache-2.0 - https://openlrae.manolodominguez.com
